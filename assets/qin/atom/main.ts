...
export class MainAtom extends Atom {
    ...
    protected _doActivate() {
        ...
        super._doActivate();
        ioc.priorityInput.highest.on(Input.EventType.TOUCH_END, this.doScreenTapped, this);
    }

    protected _doDeactivate() {
        ioc.logcat.qin.d("应用: 停用");
        ioc.priorityInput.highest.off(Input.EventType.TOUCH_END, this.doScreenTapped, this);
        super._doDeactivate();
    }
     ...
     * @param touch
     */
    protected doScreenTapped(touch: EventTouch): void {
